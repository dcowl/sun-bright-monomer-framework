...
public class ConvertUtils {
    ...
    public static Character toChar(Object value, Character defaultValue) {
        ...
        return CharsetsUtils.isEmpty(valueStr) ? defaultValue : valueStr.charAt(0);
    }
    ...
    public static Byte toByte(Object value, Byte defaultValue) {
        ...
        final String valueStr = toString(value, null);
        if (CharsetsUtils.isEmpty(valueStr)) {
            return defaultValue;
        }
        try {
    ...
    public static Integer[] toIntegerArray(String split, String str) {
        ...
        for (int i = 0; i < arr.length; i++) {
            final Integer v = toInteger(arr[i], 0);
            ints[i] = v;
        }
        return ints;
    }
    ...
    public static String utf8String(Object obj) {
        return toStringOfCharset(obj, "utf-8");
    }
     ...
     * @return 字符串
     */
    public static String toStringOfCharset(Object obj, String charsetName) {
    ...
    public static String str(byte[] bytes, String charset) {
        return str(bytes, CharsetsUtils.isEmpty(charset)
